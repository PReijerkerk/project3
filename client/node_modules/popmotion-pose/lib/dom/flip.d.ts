...
export declare const flipPose: (props: import("pose-core/lib/types").PoserState<Value, Action, ColdSubscription, DomPopmotionPoser>, nextPose: import("pose-core/lib/types").Pose<Action>) => import("pose-core/lib/types").Pose<Action>;
